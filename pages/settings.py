...
valid_password = 'Kristina123'
valid_mobile = '89771100570'
name = 'Кристина'
surname = 'Соколова'
region = 'Москва г'
email = 'treat5521@gmail.ru'
password = 'Ochika345'
valid_name = 'ЕА'
valid_name_max = 'РОСТЕЛЕКОМРОСТЕЛЕКОМРОСТЕЛЕКОМ'
thirty_one_letters_name = 'РОСТЕЛЕКОМРОСТЕЛЕКОМРОСТЕЛЕКОМР'

invalid_email = 'ttnoccka200.18@mail.ru'
invalid_password = 'Dasha123'
invalid_mobile = '89771114312662'
invalid_name = 'Е'
