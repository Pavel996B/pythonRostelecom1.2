...
# Заголовок "Авторизация" отображен на странице
...
# Кнопка "Логин" кликабельна и по ее нажатию открывается форма авторизации с полем "Логин"
...
# Авторизация по валидной почте и невалидному паролю (негативный сценарий авторизации)
...
# Авторизация по невалидной почте и валидному паролю (негативный сценарий авторизации)
...
# Авторизация по невалидной почте и невалидному паролю (негативный сценарий авторизации)
...
# Заполнение формы "Регистрация" и проверка кликабельности кнопки "Зарегистрироваться" (позитивный сценарий)
...
# Заполнение формы "Регистрация" с невалидным мобильным телефоном (на 3 цифры больше, негативный сценарий)
...
# Заполнение формы "Регистрация" с невалидным именем (менее 2 символов, негативный сценарий)
...
# Заполнение формы "Регистрация" с валидным именем (2 символа кириллицей, позитивный сценарий)
...
# Заполнение формы "Регистрация" с валидным именем (30 символов кириллицей, позитивный сценарий)
...
# Заполнение формы "Регистрация" с валидным именем (31 символ кириллицей, негативный сценарий)
